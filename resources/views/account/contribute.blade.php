...
@section('content')
    <div class="mx-auto max-w-4xl">
        ...
        <div class="space-y-6">
            ...
            {{-- The qualification forms only concern an account that is not
                 qualified yet. isContributor() is false again as soon as the
                 moderation revokes the proof, so the way back opens on its
                 own -- nothing here has to be remembered. --}}
            @if (! $isContributor)
                <div class="card">
                    <div class="card-body">
